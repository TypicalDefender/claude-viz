...
```bash
cd /Users/r/work/claude-viz && go mod init github.com/r/claude-viz
```
...
func main() {
	fmt.Println("claude-viz")
}
```

**Step 4: Verify build works**

Run: `make build && ./claude-viz`
Expected: prints "claude-viz"
...
import (
	...
	"github.com/r/claude-viz/internal/model"
)
...
import (
	...
	"github.com/r/claude-viz/internal/parser"
)
...
```bash
cd /Users/r/work/claude-viz && go get github.com/charmbracelet/bubbletea@latest github.com/charmbracelet/lipgloss@latest github.com/charmbracelet/bubbles@latest
```
...
import (
	...
	"github.com/r/claude-viz/internal/store"
)
...
func (a App) renderTabBar() string {
	...
	title := a.styles.Title.Render("claude-viz")
...
import (
	...
	tea "github.com/charmbracelet/bubbletea"
	"github.com/r/claude-viz/internal/store"
	"github.com/r/claude-viz/internal/tui"
)
