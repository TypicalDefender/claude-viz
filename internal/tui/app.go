...
import (
	...
	"github.com/TypicalDefender/claude-viz/internal/clipboard"
	"github.com/TypicalDefender/claude-viz/internal/model"
	"github.com/TypicalDefender/claude-viz/internal/parser"
	"github.com/TypicalDefender/claude-viz/internal/store"
	"github.com/TypicalDefender/claude-viz/internal/transfer"
	"github.com/TypicalDefender/claude-viz/internal/tui/components"
	"github.com/TypicalDefender/claude-viz/internal/tui/views"
)
...
func (a App) renderHelpOverlay() string {
	help := `  claude-viz — Claude Code Session Analyzer
